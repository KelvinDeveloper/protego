...
<nav class="navbar">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/">EASY<b>ERP</b></a>
    </div>
    <div class="collapse navbar-collapse" id="navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <!-- #END# Tasks
        <li class="pull-right">
          <a href="#" class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">more_vert</a>
          <ul class="dropdown-menu pull-right">
            <li><a href="/user/{{ Auth::user()->id }}"><i class="material-icons">person</i>Profile</a></li>
            <li role="seperator" class="divider"></li>
            <li><a class="stopFunction" href="/logout"><i class="material-icons">input</i>Sign Out</a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<nav class="navbar navbar-default navbar-fixed-top am-top-header">
  <div class="container-fluid">
    <div class="navbar-header">
      <div class="page-title"><span>Flot Charts</span></div><a href="#" class="am-toggle-left-sidebar navbar-toggle collapsed"><span class="icon-bar"><span></span><span></span><span></span></span></a><a href="index.php" class="navbar-brand"></a>
